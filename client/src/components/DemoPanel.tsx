...
export function DemoPanel() {
  const { stamps, toggleStamp, clearStamps, addCash, failNextVerify, setFailNextVerify, resetAll } = useApp();
  const showToast = useToast();

  return (
    <Card className="demo" aria-label="시연 도구">
      <strong>시연 도구</strong>
      <p className="sm">심사 시연 중 상태를 빠르게 바꾸는 숨김 기능이에요.</p>
      ...
      <div className="demo__section">
        ...
        <Button variant="line" onClick={clearStamps}>
          스탬프 모두 지우기
        </Button>
      </div>
